# Script para limpiar y transformar datos de lluvias 24h mensuales de Chalco, Estado de México.
import pandas as pd

df = pd.read_csv('Datos_Dia_mm.csv') # Cargar los datos desde el archivo
print("\nDatos faltantes:") 
...
Nuevo_archivo = 'Datos_Dia_mm_validados.csv'
